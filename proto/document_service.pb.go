...
func file_document_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_document_service_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_document_service_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*RenameDocument_FileName)(nil),
		(*RenameDocument_WebpageTitle)(nil),
	}
	file_document_service_proto_msgTypes[11].OneofWrappers = []interface{}{
