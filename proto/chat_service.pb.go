...
var file_chat_service_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x03, 0x69, 0x64, 0x73, 0x32, 0x91, 0x04, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74,
	...
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x55, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x22, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x62, 0x6f, 0x74, 0x2e, 0x63, 0x68, 0x61,
	0x74, 0x2e, 0x76, 0x34, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x63, 0x68, 0x61, 0x74, 0x62, 0x6f, 0x74,
	0x2e, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x76, 0x34, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74,
...
var file_chat_service_proto_depIdxs = []int32{
	...
	0,  // 14: chatbot.chat.v4.ChatService.Completion:input_type -> chatbot.chat.v4.CompletionRequest
	8,  // 15: chatbot.chat.v4.ChatService.StartThread:output_type -> chatbot.chat.v4.Thread
	7,  // 16: chatbot.chat.v4.ChatService.PostMessage:output_type -> chatbot.chat.v4.Message
	8,  // 17: chatbot.chat.v4.ChatService.GetThread:output_type -> chatbot.chat.v4.Thread
	11, // 18: chatbot.chat.v4.ChatService.ListThreadIDs:output_type -> chatbot.chat.v4.ThreadIDs
	16, // 19: chatbot.chat.v4.ChatService.DeleteThread:output_type -> google.protobuf.Empty
	16, // 20: chatbot.chat.v4.ChatService.DeleteMessageFromThread:output_type -> google.protobuf.Empty
	1,  // 21: chatbot.chat.v4.ChatService.Completion:output_type -> chatbot.chat.v4.CompletionResponse
